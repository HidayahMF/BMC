    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6 text-center">
        ...
        <button
          ...
          className="absolute top-28 left-6 md:top-8 md:left-10 z-999 inline-flex items-center gap-2 text-white/70 text-xs uppercase tracking-widest hover:text-[#D4A843] transition-colors duration-200"
        >
  ...
  return (
    <div className="bg-white font-['Roboto_Condensed',sans-serif]">
      ...
      <section className="relative h-[45vh] min-h-96 flex items-end bg-[#0D1F5C] overflow-hidden">
        ...
        <button
          onClick={() => navigate("/berita")}
          className="absolute top-28 left-6 md:top-8 md:left-10 z-[9999] pointer-events-auto inline-flex items-center gap-2 text-white/70 text-xs uppercase tracking-widest hover:text-[#D4A843] transition-colors duration-200"
        >
          <ArrowLeft size={16} />
          Kembali ke Berita
        </button>

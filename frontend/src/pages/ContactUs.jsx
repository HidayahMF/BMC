...
const ContactUs = () => {
    ...
    return (
        <div className="bg-white font-['Roboto_Condensed',sans-serif]">
            ...
            {/* ── CONTACT FORM ── */}
            <section className="bg-[#F4F6FC] py-24 px-6 md:px-20">
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <h2 className="text-[#0D1F5C] text-[28px] md:text-[36px] font-bold uppercase tracking-tight leading-[1.1] mb-4">
                            Hubungi Tim Kami
                        </h2>
                        <div className="w-[52px] h-[3px] bg-[#D4A843] mx-auto rounded-sm" />
                    </div>
                    ...
                    <form
                        ...
                        className="bg-white rounded-2xl border border-[#E3E7F3] p-8 md:p-10 space-y-5"
                        data-aos="fade-up"
                        data-aos-duration="700"
                        data-aos-delay="100"
                    >
                        <div className="grid md:grid-cols-2 gap-5">
                            <div>
                                <label className="block text-[11px] font-bold text-[#6B7A9E] uppercase tracking-wider mb-2">
                                    Nama Lengkap
                                </label>
                                <input
                                    type="text"
                                    ...
                                    className="w-full h-[46px] px-4 border-[1.5px] border-[#E3E7F3] rounded-[9px] text-[0.86rem] text-[#0D1F5C] bg-white transition-colors duration-200 placeholder-[#a0aac4] focus:outline-none focus:border-[#D4A843]"
                                />
                            </div>
                            <div>
                                <label className="block text-[11px] font-bold text-[#6B7A9E] uppercase tracking-wider mb-2">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 border-[1.5px] border-[#E3E7F3] rounded-[9px] text-[0.86rem] text-[#0D1F5C] bg-white transition-colors duration-200 placeholder-[#a0aac4] focus:outline-none focus:border-[#D4A843] resize-none"
                            />
                        </div>

                        <button
                            type="submit"
                            className="w-full md:w-auto px-10 py-[13px] bg-[#0D1F5C] text-white rounded-[9px] text-[0.78rem] font-bold tracking-[0.1em] uppercase cursor-pointer hover:opacity-90 transition-opacity"
                        >
                            Kirim Pesan
                        </button>
                        <p className="text-[#8B96C0] text-[11px]">
                            Pesan akan dikirim ke marketingteam@bmc.co.id melalui aplikasi email Anda.
                        </p>
                    </form>
                </div>
            </section>

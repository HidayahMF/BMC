    ...
    <div className="font-condensed">
      ...
      <section className="bg-[#0A1642] pt-20 pb-16 relative overflow-hidden">
        <button
          type="button"
          onClick={() => navigate("/")}
          className="absolute top-28 left-6 md:top-8 md:left-10 z-[999] pointer-events-auto inline-flex items-center gap-2 text-white/70 text-xs uppercase tracking-widest hover:text-[#D4A843] transition-colors duration-200"
        >
